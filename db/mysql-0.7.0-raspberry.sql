...
CREATE TABLE `cms_article`  (
  ...
  `summary` TEXT CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '文章摘要',
  ...
  `start_time` datetime NULL DEFAULT '0000-00-00 00:00:00' COMMENT '生效时间',
...
CREATE TABLE `sys_config`  (
  ...
  `remark` TEXT CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_log`  (
  ...
  `params` TEXT CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '请求参数',
...
CREATE TABLE `sys_menu`  (
  ...
  `perms` TEXT CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '授权(多个用逗号分隔，如：user:list,user:create)',
...
CREATE TABLE `wx_msg_reply_rule`  (
  ...
  `reply_content` TEXT CHARACTER SET utf8 NOT NULL COMMENT '回复消息内容',
...
CREATE TABLE `wx_user`  (
  ...
  `tagid_list` text NULL COMMENT '标签ID列表',
